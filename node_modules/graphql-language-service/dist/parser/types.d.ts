...
export type ParseRule = RuleOrString[] | ((token: Token, stream: CharacterStream) => string | null | void);
export type Token = {
    kind: string;
    value: string;
};
...
export declare const RuleKinds: {
    ...
    TYPE_COORDINATE: Kind.TYPE_COORDINATE;
    MEMBER_COORDINATE: Kind.MEMBER_COORDINATE;
    ARGUMENT_COORDINATE: Kind.ARGUMENT_COORDINATE;
    DIRECTIVE_COORDINATE: Kind.DIRECTIVE_COORDINATE;
    DIRECTIVE_ARGUMENT_COORDINATE: Kind.DIRECTIVE_ARGUMENT_COORDINATE;
};
export type _RuleKinds = Omit<typeof Kind, 'VARIABLE'> & typeof AdditionalRuleKinds;
