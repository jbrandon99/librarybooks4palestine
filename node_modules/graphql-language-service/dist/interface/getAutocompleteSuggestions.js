...
exports.SuggestionCommand = exports.getTypeInfo = exports.runOnlineParser = void 0;
...
function getAutocompleteSuggestions(schema, queryText, cursor, contextToken, fragmentDefs, options) {
    ...
    const context = (0, parser_1.getContextAtPosition)(queryText, cursor, schema, contextToken, options, 1);
    if (!context) {
        return [];
    }
