...
var PostHogPersistence = /** @class */ (function () {
    ...
    PostHogPersistence.prototype._partitionProps = function () {
        ...
        try {
            ...
            try {
                if (PERSISTENCE_STORAGE_GROUPS_3_1 && !PERSISTENCE_STORAGE_GROUPS_3_1.done && (_a = PERSISTENCE_STORAGE_GROUPS_3.return)) _a.call(PERSISTENCE_STORAGE_GROUPS_3);
            }
    ...
    PostHogPersistence.prototype._entryFingerprint = function (props, slot) {
        var serialized = JSON.stringify(props);
    ...
    PostHogPersistence.prototype.remove = function (_a) {
        ...
        if (!keepGroupEntries && this._ownsSplitStorage) {
            try {
                for (var PERSISTENCE_STORAGE_GROUPS_4 = __values(persistence_key_policy_1.PERSISTENCE_STORAGE_GROUPS), PERSISTENCE_STORAGE_GROUPS_4_1 = PERSISTENCE_STORAGE_GROUPS_4.next(); !PERSISTENCE_STORAGE_GROUPS_4_1.done; PERSISTENCE_STORAGE_GROUPS_4_1 = PERSISTENCE_STORAGE_GROUPS_4.next()) {
                    var group = PERSISTENCE_STORAGE_GROUPS_4_1.value;
                ...
                try {
                    if (PERSISTENCE_STORAGE_GROUPS_4_1 && !PERSISTENCE_STORAGE_GROUPS_4_1.done && (_b = PERSISTENCE_STORAGE_GROUPS_4.return)) _b.call(PERSISTENCE_STORAGE_GROUPS_4);
                }
