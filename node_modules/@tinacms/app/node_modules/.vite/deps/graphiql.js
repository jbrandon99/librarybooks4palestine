...
async function Se5(e4, t18) {
  const n7 = await import("./codemirror.es-BJHK2IYD.js").then((r10) => r10.c).then(
    (r10) => (
  ...
  return await Promise.all(
    (t18 == null ? void 0 : t18.useCommonAddons) === false ? e4 : [
      import("./show-hint.es-46GPXOKH.js").then((r10) => r10.s),
      import("./matchbrackets.es-GLWQEOLX.js").then((r10) => r10.m),
      import("./closebrackets.es-GQ5YCY5E.js").then((r10) => r10.c),
      import("./brace-fold.es-2ON7K2UI.js").then((r10) => r10.b),
      import("./foldgutter.es-CYVGAXTB.js").then((r10) => r10.f),
      import("./lint.es-V6OA5YLW.js").then((r10) => r10.l),
      import("./searchcursor.es-WOUK4ZUT.js").then((r10) => r10.s),
      import("./jump-to-line.es-ALKDUSW6.js").then((r10) => r10.j),
      import("./dialog.es-HQKCWC3Z.js").then((r10) => r10.d),
      // @ts-expect-error
      import("./sublime.es-PTC5ZFX4.js").then((r10) => r10.s),
      ...e4
    ]
  ), n7;
}
...
function Ce3({
  ...
  return (0, import_react93.useEffect)(() => {
    ...
    return Se5([
      // @ts-expect-error
      import("./javascript.es-ZO7DFP3D.js").then((C7) => C7.j)
    ]).then((C7) => {
      if (!g5)
        return;
...
function se4({
  ...
  (0, import_react93.useEffect)(() => {
    ...
    let A3 = true;
    return Se5([
      import("./comment.es-O5PNB6Y7.js").then((k3) => k3.c),
      import("./search.es-D4KBXWYL.js").then((k3) => k3.s),
      import("./hint.es-IWV67JFO.js"),
      import("./lint.es2-VI5AF435.js"),
      import("./info.es-3MNXZSJE.js"),
      import("./jump.es-PQZIH2TX.js"),
      import("./mode.es-SP6WC3TC.js")
    ]).then((k3) => {
      if (!A3)
        return;
      D7.current = k3;
...
function me4({
  ...
  return (0, import_react93.useEffect)(() => {
    let C7 = true;
    return Se5([
      import("./hint.es2-HQL4575S.js"),
      import("./lint.es3-AKRHCM6X.js"),
      import("./mode.es2-DADORLZW.js")
    ]).then((d16) => {
      if (!C7)
        return;
      g5.current = d16;
...
function it4({
  ...
  return (0, import_react93.useEffect)(() => {
    ...
    return Se5(
      [
        import("./foldgutter.es-CYVGAXTB.js").then((u13) => u13.f),
        import("./brace-fold.es-2ON7K2UI.js").then((u13) => u13.b),
        import("./dialog.es-HQKCWC3Z.js").then((u13) => u13.d),
        import("./search.es-D4KBXWYL.js").then((u13) => u13.s),
        import("./searchcursor.es-WOUK4ZUT.js").then((u13) => u13.s),
        import("./jump-to-line.es-ALKDUSW6.js").then((u13) => u13.j),
        // @ts-expect-error
        import("./sublime.es-PTC5ZFX4.js").then((u13) => u13.s),
        import("./mode.es3-XGLTU25Z.js"),
        import("./info-addon.es-5DW5DN65.js")
      ],
